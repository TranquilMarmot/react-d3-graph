...
var Graph = /*#__PURE__*/ (function(_React$Component) {
  ...
  function Graph(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_snapNodeToGrid", function(nodeId) {
      var node = _this.state.nodes[nodeId];

      var _snapPointToGrid = (0, _graph3.snapPointToGrid)(node.x, node.y, _this.state.config.grid),
        x = _snapPointToGrid.x,
        y = _snapPointToGrid.y;
    ...
    _defineProperty(_assertThisInitialized(_this), "_onDragEnd", function() {
      ...
      if (_this.state.draggedNode) {
        ...
        if (_this.state.config.grid.snapToGrid) {
          _this._snapNodeToGrid(_this.state.draggedNode.id);
        }
      ...
      value: function render() {
        ...
        return _react["default"].createElement(
          ...
          _react["default"].createElement(
            ...
            defs,
            this.state.config.grid.renderGridLines && // this rect is filled with a pattern generated in the `defs` above
              _react["default"].createElement("rect", {
                id: "".concat(this.state.id, "-").concat(_graph["default"].GRID_LINES_CONTAINER_ID),
                width: "100%",
                height: "100%",
                fill: "url(#".concat(_graph["default"].GRID_LINES_LARGE_GRID_PATTERN_ID, ")"),
              }),
            _react["default"].createElement(
              "g",
              _extends(
