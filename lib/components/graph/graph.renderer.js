...
var _renderGridLineDefs = function _renderGridLineDefs(config, transform) {
  var _config$grid = config.grid,
    renderGridLines = _config$grid.renderGridLines,
    gridWidth = _config$grid.gridWidth,
    gridHeight = _config$grid.gridHeight,
    strokeColor = _config$grid.strokeColor,
    innerGridStrokeWidth = _config$grid.innerGridStrokeWidth,
    strokeWidth = _config$grid.strokeWidth,
    innerGridStrokeColor = _config$grid.innerGridStrokeColor,
    innerGridXDivisions = _config$grid.innerGridXDivisions,
    innerGridYDivisions = _config$grid.innerGridYDivisions; // grid lines turned off; return nothing

  if (!renderGridLines) {
    return {};
  }

  var width = gridWidth * transform.k;
  var height = gridHeight * transform.k;
  return _react["default"].createElement(
    ...
    _react["default"].createElement(
      "pattern",
      {
        id: _graph["default"].GRID_LINES_SMALL_GRID_PATTERN_ID,
        width: width / innerGridXDivisions,
        height: height / innerGridYDivisions,
        patternUnits: "userSpaceOnUse",
      },
      _react["default"].createElement("path", {
        d: "M ".concat(width / innerGridXDivisions, " 0 L 0 0 0 ").concat(height / innerGridYDivisions),
        fill: "none",
    ...
    _react["default"].createElement(
      "pattern",
      {
        id: _graph["default"].GRID_LINES_LARGE_GRID_PATTERN_ID,
        x: transform.x,
        y: transform.y,
        width: width,
        height: height,
      ...
      _react["default"].createElement("rect", {
        width: width,
        height: height,
        fill: "url(#".concat(_graph["default"].GRID_LINES_SMALL_GRID_PATTERN_ID, ")"),
      }),
      _react["default"].createElement("path", {
        d: "M ".concat(width, " 0 L 0 0 0 ").concat(width),
        fill: "none",
        stroke: strokeColor,
...
function renderGraph(
  ...
  return {
    ...
    defs: _objectSpread({}, _memoizedRenderDefs(config), {}, _renderGridLineDefs(config, transform)),
  };
}
